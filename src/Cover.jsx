const Cover = () => {
    return (
        <div>
            {/* Hero Section */}
            <div
                className="mt-[90px]  mx-[0px] w-full h-[300px] sm:h-[400px] rounded-[20px] flex justify-center items-center text-white bg-center bg-cover relative overflow-hidden"
                style={{
